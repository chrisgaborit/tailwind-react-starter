import { ModuleLevel } from './types'; // Keep ModuleLevel if still used for hints or defaults
...
export const FORM_ERROR_MESSAGE =
  "Please fill in all required fields marked with * and provide the main content. Ensure module level, module type, audience and tone are selected.";
export const DURATION_HINT = "e.g., \"10-15 minutes\" or \"approx 15 screens\"";

export const API_KEY_ERROR_MESSAGE =
  "API_KEY environment variable not found. Please ensure it is configured for the execution environment.";
export const MODULE_TYPE_LOGIC_ERROR =
  "Internal error: Could not find specific logic for the provided module type.";


// Example of how LEVEL_DEFINITIONS could be structured if needed for UI hints
